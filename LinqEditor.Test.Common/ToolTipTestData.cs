...
namespace LinqEditor.Test.Common
{
    public static class ToolTipTestData
    {
            ...
            new Dictionary<string, Tuple<string, int, ToolTipData>>
        {
            ...
            {ComplexStatementsExampleTwo_TupleItem2Property, Tuple.Create(SourceCodeFragments.ComplexStatementsExampleTwo, 661, new ToolTipData {
                ItemName = "IEnumerable<int> Tuple<int, IEnumerable<int>>.Item2",
                Description = "Gets the value of the current System.Tuple<T1, T2> object's second component.",
                Addendums = new List<string> { }
            })},
            {ComplexStatementsExampleTwo_SecondTupleItem2Property, Tuple.Create(SourceCodeFragments.ComplexStatementsExampleTwo, 534, new ToolTipData {
                ItemName = "IEnumerable<int> Tuple<int, IEnumerable<int>>.Item2",
                Description = "Gets the value of the current System.Tuple<T1, T2> object's second component.",
                Addendums = new List<string> { }
            })},
            ...
            {ComplexStatementsExampleTwo_StringJoinMethod, Tuple.Create(SourceCodeFragments.ComplexStatementsExampleTwo, 620, new ToolTipData {
            ...
            {ComplexStatementsExampleTwo_SelectExtensionMethod, Tuple.Create(SourceCodeFragments.ComplexStatementsExampleTwo, 597, new ToolTipData {
            ...
            {ComplexStatementsExampleTwo_OtherSelectExtensionMethod, Tuple.Create(SourceCodeFragments.ComplexStatementsExampleTwo, 800, new ToolTipData {
            ...
            {ComplexStatementsExampleTwo_ConcatExtensionMethod, Tuple.Create(SourceCodeFragments.ComplexStatementsExampleTwo, 653, new ToolTipData {
            ...
            {ComplexStatementsExampleTwo_SecondZParameterReference, Tuple.Create(SourceCodeFragments.ComplexStatementsExampleTwo, 603, new ToolTipData {
                ItemName = "(parameter) Tuple<int, IEnumerable<int>> z",
                Description = "",
                Addendums = new List<string> { }
            })},
            ...
            {ComplexStatementsExampleTwo_MyVarLocalVariableReference, Tuple.Create(SourceCodeFragments.ComplexStatementsExampleTwo, 914, new ToolTipData {
